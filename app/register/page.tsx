...
export default function Register() {
  ...
  const handleSignUp = async () => {
    let d = await supabase.auth.signUp({
      email,
      password,
    });
  ...
  return (
    <section>
      <div className="2xl:max-w-7xl mx-auto 2xl:border-x-2 border-black">
        <div className="relative justify-center max-h-full overflow-hidden  grid lg:grid-cols-2 h-screen lg:divide-x-2 divide-black">
          <div className="relative z-10 flex flex-col flex-1 px-4 py-10 bg-red-500 lg:py-24 md:flex-none md:px-28 sm:justify-center">
            <div className="w-full mx-auto md:px-0 sm:px-4 text-center">
              <h2 className="text-3xl lg:text-5xl font-medium text-black max-w-4xl">
                Sign up to Flabbergasted
              </h2>
              <p className="mt-4 xl:text-xl tracking-wide text-black">
                Join over 000,000 Flabbergasted who have earned over
                $000,000,000 on Lexington selling digital products and
                memberships.
              </p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <p className="text-sm lg:text-2xl text-black">
                      Already have a pass?
                      <Link
                        className="text-black lg:text-2xl hover:text-lila-500 underline ml-3"
                        href="/login"
                      >
                        Log in now
                      </Link>
          ...
          <div className="hidden bg-lila-500 lg:block lg:flex-1 lg:relative sm:contents">
            <div className="absolute inset-0 object-cover w-full h-full bg-yellow-500">
              <img
